...
TOKEN = '8830759236:AAEK_kVmhJnNTUdbZtFSFI8JYfzMNkOx-Bk'  # ⚠️ Pon aquí tu token nuevo (revoca el viejo)
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text("🤖 Bot OSINT funcionando. Usa /username <nombre>")
